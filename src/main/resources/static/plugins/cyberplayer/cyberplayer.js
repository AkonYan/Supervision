        ...
        return function (a) {
            ...
            function (a, b, c) {
                ...
                void 0 !== (e = function (a, b, c, d, e, f, g, h, i) {
                    ...
                    function m(m, x) {
                        function y() {
                            xa && (ha(La.audioTracks), ra.setTextTracks(La.textTracks), La.setAttribute("jw-loaded", "data"))
                        }
                        function z() {
                        ...
                        function D() {
                            n(va),
                                ta = !0,
                            xa && (ra.state === f.STALLED ? ra.setState(f.PLAYING) : ra.state === f.PLAYING && (va = setTimeout(_, o)), za && La.duration === 1 / 0 && 0 === La.currentTime || (I(H()), G(La.currentTime), F(aa(), oa, na), ra.state === f.PLAYING && (ra.trigger(e.JWPLAYER_MEDIA_TIME, {
                                position: oa,
                                duration: na
                            }), E())))
                        }
                        function E() {
                            ...
                            if (a.width !== La.videoWidth || a.height !== La.videoHeight) {
                                ...
                                Ha.reason = Ha.reason || "auto",
                                    Ha.mode = "hls" === qa[ya].type ? "auto" : "manual",
                                    Ha.bitrate = 0,
                                    a.index = ya,
                                    a.label = qa[ya].label,
                                    ra.trigger("visualQuality", Ha),
                                    Ha.reason = ""
                            }
                        }
                        function F(a, b, c) {
                        ...
                        function I(a) {
                            na = a,
                            ua && a && a !== 1 / 0 && ra.seek(ua)
                        }
                        function J() {
                            var a = H();
                            za && a === 1 / 0 && (a = 0),
                                ra.trigger(e.JWPLAYER_MEDIA_META, {
                                    duration: a,
                        ...
                        function N() {
                            ra.setState(f.PLAYING),
                            La.hasAttribute("jw-played") || La.setAttribute("jw-played", ""),
                                ra.trigger(e.JWPLAYER_PROVIDER_FIRST_FRAME, {})
                        }
                        function O() {
                        ...
                        function Q() {
                            xa && (b.log("Error playing media: %o %s", La.error, La.src), ra.trigger(e.JWPLAYER_MEDIA_ERROR, {
                        ...
                        function S(a) {
                            qa = a,
                                ya = T(a);
                            var b = R(a);
                            b && ra.trigger(e.JWPLAYER_MEDIA_LEVELS, {
                                levels: b,
                                currentQuality: ya
                            })
                        }
                        function T(a) {
                            ...
                            return Ha.reason = "initial choice",
                                Ha.level = {},
                                b
                        }
                        function U(a, c) {
                            ...
                            d.src = qa[ya].file;
                            var e = La.src !== d.src,
                                g = La.getAttribute("jw-loaded"),
                                h = La.hasAttribute("jw-played");
                            e || "none" === g || "started" === g ? (na = c, ra.setupSideloadedTracks(Ga), b.isHtml5Flv(qa[ya].file, qa[ya].type) && Ia ? (Ia.load(), Ia.play()) : (V(qa[ya]), La.load()), s && La.paused && La.play()) : (0 === a && La.currentTime > 0 && (ua = -1, ra.seek(a)), b.isHtml5Flv(qa[ya].file, qa[ya].type) && Ia ? Ia.play() : La.play()),
                                oa = La.currentTime,
                            r && !h && (M(), La.paused || ra.state === f.PLAYING || ra.setState(f.LOADING)),
                            b.isIOS() && ra.getFullScreen() && (La.controls = !0),
                            a > 0 && ra.seek(a)
                        }
                        function V(a) {
                            Da = null,
                                Ea = -1,
                                Fa = -1,
                            Ha.reason || (Ha.reason = "initial choice", Ha.level = {}),
                                ta = !1,
                                pa = !1,
                                za = l(a),
                            a.preload && a.preload !== La.getAttribute("preload") && La.setAttribute("preload", a.preload);
                            var b = document.createElement("source");
                            b.src = a.file,
                            La.src !== b.src && (La.setAttribute("jw-loaded", "none"), La.src = a.file)
                        }
                        function W() {
                            La && (ra.disableTextTrack(), La.removeAttribute("crossorigin"), La.removeAttribute("preload"), La.removeAttribute("src"), La.removeAttribute("jw-loaded"), La.removeAttribute("jw-played"), c.emptyElement(La), ya = -1, Ga = null, !q && "load" in La && La.load())
                        }
                        function X() {
                        ...
                        function Z() {
                            ra.seeking = !1,
                                ra.trigger(e.JWPLAYER_MEDIA_SEEKED)
                        }
                        function $() {
                            ra.trigger("volume", {
                        ...
                        function ca() {
                            n(va),
                                ra.setState(f.COMPLETE),
                                Ba = !1,
                                ra.trigger(e.JWPLAYER_MEDIA_COMPLETE)
                        }
                        function da(a) {
                            Ca = !0,
                                ga(a),
                            ...
                            if (Da = null, a) {
                                if (a.length) {
                                    for (var b = 0; b < a.length; b++) if (a[b].enabled) {
                                        Ea = b;
                                        break
                                    } - 1 === Ea && (Ea = 0, a[Ea].enabled = !0),
                                        Da = d.map(a, function (a) {
                                            return {
                                ...
                                ra.addTracksListener(a, "change", ea),
                                Da && ra.trigger("audioTracks", {
                                    currentTrack: Ea,
                                    tracks: Da
                                })
                            }
                        ...
                        function la() {
                            if ("hls" === qa[0].type) {
                                var a = "video";
                                0 === La.videoHeight && (a = "audio"),
                                    ra.trigger("mediaType", {
                                        mediaType: a
                                    })
                            }
                        }
                        ...
                        La = La || document.createElement("video"),
                            ...
                            this.itemTracks = Ga,
                            this.video = La,
                        d.isObject(x.cast) && x.cast.appid && La.setAttribute("disableRemotePlayback", ""),
                            j(sa, La),
                        u || (La.controls = !0, La.controls = !1),
                            La.setAttribute("x-webkit-airplay", "allow"),
                            La.setAttribute("webkit-playsinline", ""),
                            La.setAttribute("playsinline", ""),
                            this.stop = function () {
                                n(va),
                                xa && (W(), b.isIETrident() && La.pause(), this.setState(f.IDLE))
                            },
                            this.destroy = function () {
                                k(sa, La),
                                    this.removeTracksListener(La.audioTracks, "change", ea),
                                    this.removeTracksListener(La.textTracks, "change", ra.textTrackChangeHandler),
                                    this.remove(),
                                    this.off(),
                                Ia && (Ia.destroy(), Ia = null)
                            },
                            this.init = function (a, c) {
                                xa && (Ga = null, qa = a.sources, ya = T(a.sources), a.sources.length && "hls" !== a.sources[0].type && this.sendMediaType(a.sources), oa = a.starttime || 0, na = a.duration || 0, Ha.reason = "", V(qa[ya]), this.setupSideloadedTracks(a.tracks), Ga = this.itemTracks, Ja = c, b.isHtml5Flv(qa[ya].file, qa[ya].type) && this.initFlvPlayer())
                            },
                            this.initFlvPlayer = function () {
                                var a = this;
                                Ia && Ia.destroy();
                                var b = {};
                                Ja.minBufferLength > 0 && (b.lazyLoadMaxDuration = Ja.minBufferLength, Ja.minBufferLength < 30 && (b.lazyLoadRecoverDuration = Ja.minBufferLength)),
                                    Ia = window.flvjs.createPlayer({
                                        type: "flv",
                                        isLive: Ja.isLive,
                                        url: qa[ya].file
                                    }, b),
                                    Ia.attachMediaElement(La),
                                    Ia.on(e.JWPLAYER_ERROR, function (b, c, d) {
                            ...
                            this.remove = function () {
                                W(),
                                    n(va),
                                ma === La.parentNode && ma.removeChild(La),
                                Ia && (Ia.pause(), Ia.unload(), Ia.detachMediaElement())
                            },
                            ...
                            this.resize = function (b, c, d) {
                                ...
                                if ("uniform" === d) {
                                    var f = b / c,
                                        g = La.videoWidth / La.videoHeight;
                                    Math.abs(f - g) < .09 && (e.objectFit = "fill", d = "exactfit")
                                }
                                if (p || t || u || v) {
                                    var h = -Math.floor(La.videoWidth / 2 + 1),
                                        i = -Math.floor(La.videoHeight / 2 + 1),
                                        j = Math.ceil(100 * b / La.videoWidth) / 100,
                                        k = Math.ceil(100 * c / La.videoHeight) / 100;
                                    "none" === d ? j = k = 1 : "fill" === d ? j = k = Math.max(j, k) : "uniform" === d && (j = k = Math.min(j, k)),
                                        e.width = La.videoWidth,
                                        e.height = La.videoHeight,
                                        e.top = e.left = "50%",
                                        e.margin = 0,
                                        a.transform(La, "translate(" + h + "px, " + i + "px) scale(" + j.toFixed(2) + ", " + k.toFixed(2) + ")")
                                }
                                return a.style(La, e),
                                    !1
                            },
                            ...
                            this.setCurrentQuality = function (a) {
                                if (ya !== a && a >= 0 && qa && qa.length > a) {
                                    ...
                                    var c = La.currentTime || 0,
                                        d = La.duration || 0;
                                    d <= 0 && (d = na),
                                        ra.setState(f.LOADING),
                                    b.isHtml5Flv(qa[ya].file, qa[ya].type) && this.initFlvPlayer(),
                                        U(c, d)
                                }
                            },
                            ...
                            this.setCurrentAudioTrack = ia,
                            this.getAudioTracks = ja,
                            this.getCurrentAudioTrack = ka,
                            this.setPlaybackRate = function (a) {
                                La.playbackRate = a,
            ...
            function (a, b, c) {
                ...
                void 0 !== (e = function (a, b, c) {
                    ...
                    return [{
                        ...
                        name: "videojs",
                        supports: function (b) {
                            return !(a.isChrome() && parseInt(a.getChromeVersion()) < 50) && window.videojs && window.videojs.MediaSource && window.videojs.MediaSource.supportsNativeMediaSources() && "hls" === b.type
                        }
                    }, {
                        name: "flash",
                        supports: function (c) {
                        ...
                        var s = function () {
                            o = new g(m),
                                ...
                                o.on(a.JWPLAYER_ERROR, function (a) {
                                    if ("mediaError" === a.type && a.detail && "DEMUXER_ERROR_COULD_NOT_OPEN: FFmpegDemuxer: open context failed" === a.detail.message && d.isMp4(a.videoSrc)) {
                        ...
                        setup: function (g, n) {
                            ...
                            function A(a) {
                                ...
                                if (a && ca.set("playReason", a.reason), ca.get("state") !== p.ERROR) {
                                    ...
                                    if (ca.get("state") === p.COMPLETE && (B(!0), H(0)), !da && (da = !0, fa.trigger(q.JWPLAYER_MEDIA_BEFOREPLAY, {
                                        file: ca.get("file") || ca.get("playlistItem").file
                                    }), da = !1, ba)) return ba = !1,
                                        void(aa = null);
                                    if (D()) {
                ...
                void 0 !== (e = function (a, b, d, e, f, g, h, i, j, k) {
                    function l() {
                        return {
                            ...
                            LOAD_PROVIDERS: {
                                method: H,
                                depends: ["FILTER_PLAYLIST", "LOAD_FLVJS", "LOAD_VIDEOJS_LEVELS"]
                            },
                            LOAD_SKIN: {
                                method: G,
                                depends: ["LOADED_POLYFILLS"]
                    ...
                    function r(a, b) {
                        if (q(b.get("playlist")) && window.videojs && !window.videojs.getPlugin("qualityLevels")) {
                ...
                void 0 !== (e = function (a, b, c, d, e, f, g, h, i) {
                    ...
                    function l(l, w) {
                        ...
                        function C() {
                            p(ua),
                                sa = !0,
                            wa && (qa.state === f.STALLED ? qa.setState(f.PLAYING) : qa.state === f.PLAYING && (ua = setTimeout(Z, q)), Ha.duration === 1 / 0 && 0 === Ha.currentTime || (G(F()), E(Ha.currentTime), D($(), na, ma), qa.state === f.PLAYING && qa.trigger(e.JWPLAYER_MEDIA_TIME, {
                                position: na,
                                duration: ma
                            })))
                        }
                        ...
                        function G(a) {
                            ma = a,
                            ta && a && a !== 1 / 0 && qa.seek(ta)
                        }
                        function H() {
                            var a = F();
                            a === 1 / 0 && (a = 0),
                                qa.trigger(e.JWPLAYER_MEDIA_META, {
                                    duration: a,
                        ...
                        function L() {
                            qa.setState(f.PLAYING),
                            Ha.hasAttribute("jw-played") || Ha.setAttribute("jw-played", ""),
                                qa.trigger(e.JWPLAYER_PROVIDER_FIRST_FRAME, {})
                        }
                        function M() {
                        ...
                        function R(a) {
                            var b = Math.max(0, xa),
                                c = w.qualityLabel;
                            if (a) for (var d = 0; d < a.length; d++) if (a[d]["default"] && (b = d), c && a[d].label === c) return d;
                            return Fa.reason = "initial choice",
                                Fa.level = {},
                                b
                        }
                        function S(a, b) {
                            ...
                            d || "none" === e || "started" === e ? (ma = b, qa.setupSideloadedTracks(Ea), T(pa[xa]), t && setTimeout(function () {
                                m.play()
                            }, 500), s && Ha.paused && setTimeout(function () {
                                m.play()
                            }, 2500)) : (0 === a && Ha.currentTime > 0 && (ta = -1, qa.seek(a)), m.play()),
                                na = Ha.currentTime,
                            a > 0 && qa.seek(a)
                        }
                        function T(a) {
                            Ba = null,
                                Ca = -1,
                                Da = -1,
                            Fa.reason || (Fa.reason = "initial choice", Fa.level = {}),
                                sa = !1,
                                oa = !1,
                            a.preload && a.preload !== Ha.getAttribute("preload") && Ha.setAttribute("preload", a.preload);
                            var b = document.createElement("source");
                            b.src = a.file,
                            Ha.src !== b.src && (Ha.setAttribute("jw-loaded", "none"), m.src({
                                src: a.file,
                        ...
                        function X() {
                            qa.seeking = !1,
                                qa.trigger(e.JWPLAYER_MEDIA_SEEKED)
                        }
                        function Y() {
                            qa.trigger("volume", {
                        ...
                        function aa() {
                            p(ua),
                                qa.setState(f.COMPLETE),
                                za = !1,
                                qa.trigger(e.JWPLAYER_MEDIA_COMPLETE)
                        }
                        function ba(a) {
                            Aa = !0,
                                ea(a)
                            ...
                            if (Ba = null, a) {
                                if (a.length) {
                                    for (var b = 0; b < a.length; b++) if (a[b].enabled) {
                                        Ca = b;
                                        break
                                    } - 1 === Ca && (Ca = 0, a[Ca].enabled = !0),
                                        Ba = d.map(a, function (a) {
                                            return {
                                                name: a.label || a.language,
                                                language: a.language
                                            }
                                ...
                                qa.addTracksListener(a, "change", ca),
                                Ba && qa.trigger("audioTracks", {
                                    currentTrack: Ca,
                                    tracks: Ba
                                })
                            }
                        ...
                        Ha = Ha || document.createElement("video"),
                            Ha.className = "jw-video jw-reset",
                            m = window.videojs(Ha),
                            this.isSDK = ya,
                            this.itemTracks = Ea,
                            this.video = Ha,
                        d.isObject(w.cast) && w.cast.appid && Ha.setAttribute("disableRemotePlayback", ""),
                            j(ra, Ha),
                            Ha.controls = !0,
                            Ha.controls = !1,
                            this.stop = function () {
                                p(ua),
                                wa && (U(), b.isIETrident() && m.pause(), this.setState(f.IDLE))
                            },
                            this.destroy = function () {
                                k(ra, Ha),
                                    this.removeTracksListener(Ha.audioTracks, "change", ca),
                                    this.removeTracksListener(Ha.textTracks, "change", qa.textTrackChangeHandler),
                                    this.remove(),
                                    this.off()
                            },
                            ...
                            this.setContainer = function (a) {
                                ...
                                la = a,
                                    a.appendChild(Ha),
                                    m.on(e.JWPLAYER_MEDIA_LEVELS, function (a) {
                            ...
                            this.remove = function () {
                                U(),
                                    p(ua),
                                la === Ha.parentNode && la.removeChild(Ha),
                                    m.dispose()
                            },
                            this.setVisibility = function (b) {
                                b = !! b,
                            ...
                            this.setCurrentQuality = function (a) {
                                ...
                                if (!(xa === a || a < 0)) if (b.isMutipleHls(pa)) {
                                    ...
                                    var d = Ha.currentTime || 0,
                                        g = Ha.duration || 0;
                                    g <= 0 && (g = ma),
                                        qa.setState(f.LOADING),
                                        S(d, g),
                                        setTimeout(function () {
                                            c.seek(d),
                                                c.play()
                                    ...
                                    var h = m.qualityLevels();
                                    h[a] && m.tech({
                                        IWillNotUseThisInPlugins: !0
                                    }).hls.playlists.media(h[a].id)
                                }
                            },
                            this.getCurrentQuality = function () {
                                return xa
                            ...
                            this.setCurrentAudioTrack = ha,
                            this.getAudioTracks = ia,
                            this.getCurrentAudioTrack = ja,
                            this.setPlaybackRate = function (a) {
                                Ha.playbackRate = a,
                                    this.trigger(e.JWPLAYER_PLAYBACKRATE, {
                                        playbackRate: a
                    ...
                    return a.extend({
                        ...
                        selectItem: function (a) {
                            ...
                            if (this.isHDMenu() && this.list && this.list.length >= 2) {
                                ...
                                b.getElementsByClassName("jw-hd-label", this.el)[0].innerHTML = d
                            }
