...
///<param name="line">播放线路</param>
///<returns></returns>
function StartPlayHandle2(elevCode, PlayOCX, line) {
    //iPlayHandle = PlayOCX.StartVideoByEhomeTCP(line);
    //if (iPlayHandle > 0) {
    //    VedioPlayLog(elevCode, true);
    //}
    ...
    PlayOCX.palyvideo(regSvrIp, regSvrPort, streamSvrIp, streamSvrPort, elevCode, 0, iStreamCodeType, 1);
    VedioPlayLog(elevCode, true);
}
...
function StartPlayByChannel(elevCode, iDeviceIndex) {
    ...
    //播放视频
    StartPlayHandle2(elevCode, PlayOCX, line);
